...
function App() {
  return (
    <div>
      ...
      <section className="services">
        ...
        <div className="row row4">
          <div className="service">
            <p>
              <span className="highlight"> Reservas Intuitivas:</span> Creamos una
              plataforma de reserva con una interfaz amigable que te permite
              encontrar y reservar canchas de forma rápida y sencilla.
            </p>
          </div>
          <div className="service">
            <p>
              <span className="highlight">Reservas en Tiempo Real: </span> Nuestro
              sistema de reservas actualiza la disponibilidad de las canchas al
              instante, evitando duplicados y garantizando información precisa.
            </p>
          </div>
          <div className="service">
            <p>
          ...
          <div className="service">
            <p>
              <span className="highlight"> Personalización Total:</span> Personaliza
              tu búsqueda de canchas según deporte, ubicación y características
              de la cancha.
            </p>
          </div>
        </div>
      ...
      <section>
        <div className="row nomargin">
          <h2 className="section_title">Ponte en Contacto</h2>
        </div>
        <div className="row row2">
          <div>
            <h2>
              Si tienes una cancha en propiedad y quieres saber como publicarla,
